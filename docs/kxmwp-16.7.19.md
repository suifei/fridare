...
| `frida-kxmwp-16.7.19-host-wheels.zip` | 各平台魔改 `frida==16.7.19` 原生 wheel |
| `frida_tools-13.7.1+frida.16.7.19.fridare.kxmwp-py3-none-any.whl` | 魔改 `frida-tools`（纯 Python，任意宿主机） |
